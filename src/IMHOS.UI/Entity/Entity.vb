...
Public Class Entity
    ...
    Sub New(sprite As ISprite, position As (Single, Single), color As IReadValueSource(Of (Byte, Byte, Byte, Byte)), rotation As IReadValueSource(Of Single))
        Me.sprite = sprite
    ...
    Sub Draw(renderer As Object) Implements IEntity.Draw
        sprite.Draw(renderer, position, color.Read(), rotation.Read())
    End Sub
End Class
